...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Sports Center — Booking lapangan olahraga online dengan mudah dan cepat. Futsal, Badminton, Basket, dan lainnya.'); ?>">

    <title><?php echo $__env->yieldContent('title', 'Sports Center'); ?> — Booking Lapangan Online</title>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-18">
                ...
                <div class="hidden md:flex items-center gap-1">
                    <a href="<?php echo e(route('home')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all duration-200">
                        Beranda
                    </a>
                    <a href="<?php echo e(route('booking.index')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all duration-200">
                        Lapangan
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('booking.my-bookings')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all duration-200">
                            Booking Saya
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <?php if(auth()->guard()->check()): ?>
                        <div class="hidden md:flex items-center gap-3">
                            <span class="text-sm text-white/70"><?php echo e(auth()->user()->name); ?></span>
                            <?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium bg-white/10 text-white hover:bg-white/20 transition-all duration-200">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="hidden md:inline-flex px-5 py-2.5 rounded-xl text-sm font-semibold bg-white/15 text-white hover:bg-white/25 backdrop-blur-sm transition-all duration-200 border border-white/20">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-surface-900/95 backdrop-blur-xl border-t border-white/10">
            <div class="px-4 py-4 space-y-1">
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 rounded-xl text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all">Beranda</a>
                <a href="<?php echo e(route('booking.index')); ?>" class="block px-4 py-3 rounded-xl text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all">Lapangan</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('booking.my-bookings')); ?>" class="block px-4 py-3 rounded-xl text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all">Booking Saya</a>
                    <?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 rounded-xl text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-all">Admin Panel</a>
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block px-4 py-3 rounded-xl text-sm font-medium text-primary-300 hover:bg-white/10 transition-all">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-sm text-surface-300 hover:text-white transition-colors">Beranda</a></li>
                        <li><a href="<?php echo e(route('booking.index')); ?>" class="text-sm text-surface-300 hover:text-white transition-colors">Daftar Lapangan</a></li>
                        <li><a href="<?php echo e(route('login')); ?>" class="text-sm text-surface-300 hover:text-white transition-colors">Login</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-white/10 mt-12 pt-8 text-center">
                <p class="text-sm text-surface-500">&copy; <?php echo e(date('Y')); ?> Sports Center. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH D:\DEVELOPMENTS\MOA-GITS\sistem-booking-lapangan\resources\views/layouts/app.blade.php ENDPATH**/ ?>