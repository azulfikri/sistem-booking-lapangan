<x-layouts.admin title="Manajemen Admin">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola akses admin sistem</p>
        </div>
        <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors shadow-sm">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors {{ $user->id === auth()->id() ? 'bg-blue-50' : '' }}">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-gray-900">
                                            {{ $user->name }}
                                            @if($user->id === auth()->id())
                                                <span class="ml-2 px-2 py-0.5 text-xs bg-blue-100 text-blue-800 rounded">You</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    @else
                                        <span class="text-gray-400 cursor-not-allowed" title="Anda tidak dapat menghapus akun Anda sendiri">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                            </svg>
                                        </span>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="mt-4">Belum ada admin.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
